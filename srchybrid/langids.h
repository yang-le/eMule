...
#define LANGID_FR_BR MAKELANGID(LANG_BRETON, SUBLANG_DEFAULT)
...
#define LANGID_MT_MT MAKELANGID(LANG_MALTESE, SUBLANG_DEFAULT)
...
#define LANGID_UG_CN MAKELANGID(LANG_UIGHUR, SUBLANG_DEFAULT)
