...
/** \addtogroup Constructors */ //@{
	explicit CxImage(uint32_t imagetype = 0);
...
/** \addtogroup Attributes */ //@{
	...
	uint32_t	GetCodecOption(uint32_t imagetype = 0) const;
...
protected:
/** \addtogroup Protected */ //@{
	static void  AddAveragingCont(RGBQUAD const &color, float const surf, float &rr, float &gg, float &bb, float &aa);
//@}
...
/** \addtogroup DSP */ //@{
	...
	bool HistogramRoot();
	bool HistogramLog();
	int32_t Histogram(int32_t* red, int32_t* green = 0, int32_t* blue = 0, int32_t* gray = 0, int32_t colorspace = 0) const;
...
/** \addtogroup Protected */ //@{
	...
	static bool FFT(int32_t dir, int32_t m, double *x, double *y);
	static bool DFT(int32_t dir, int32_t m, double *x1, double *y1, double *x2, double *y2);
	...
	static void blur_line (float *ctable, float *cmatrix, int32_t cmatrix_length, uint8_t* cur_col, uint8_t* dest_col, int32_t y, int32_t bytes);
...
/** \addtogroup Alpha */ //@{
	...
	bool AlphaPaletteIsEnabled() const;
	bool AlphaPaletteIsValid() const;
...
/** \addtogroup Protected */ //@{
	...
	int16_t m_ntohs(const int16_t word) const;
	int32_t m_ntohl(const int32_t dword) const;
	void bihtoh(BITMAPINFOHEADER* bih) const;
